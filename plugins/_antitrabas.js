...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  const fakemek = { 'key': { 'participant': '0@s.whatsapp.net', 'remoteJid': '0@s.whatsapp.net' }, 'message': { 'groupInviteMessage': { 'groupJid': '529861009341-1616969743@g.us', 'inviteCode': 'm', 'groupName': 'P', 'caption': '𝙊𝘾𝙀𝘼𝙉 𝘾𝙊𝙍𝙋', 'jpegThumbnail': null } } };
